...
![Soham's GitHub Stats](https://readme-stats-gilt-six.vercel.app/api?username=SohamKela&show_icons=true&theme=aura&count_private=true&include_all_commits=true)
![Top Languages](https://readme-stats-gilt-six.vercel.app/api/top-langs/?username=SohamKela&layout=compact&theme=aura&count_private=true&hide=Jupyter%20Notebook,Makefile)
...
### Crabtree Creek Flood Forecasting — NC State Research
Machine learning research under Dr. Ranjithan to support municipal flood response.
- Co-developing an **Elastic-Net regression** model predicting creek water levels **150 minutes ahead** for 500k+ Raleigh residents
- Engineered **99 features across 7 USGS sites**, achieving ~0.5 ft mean absolute error on a 2.5-hour forecast horizon
- Presented the model to the **City of Raleigh** as part of an ongoing collaboration
...
- 🔬 **ML Research Intern**, NC State University — flood-forecasting models for the City of Raleigh
- 💊 **Innovation & Finance Intern**, Regeneron Pharmaceuticals — pharma R&D financial strategy & capital allocation
- 🎓 **Foundation Attaché**, NCSSM Foundation — 1 of 11 selected from 300+; led video strategy for a campaign raising **$275k in 24 hours**
- 🏅 **Co-President**, DECA NCSSM Chapter — grew a 120+ member chapter to 30+ state & international wins and an Int'l Platinum Seal of Excellency

---

## 📸 Photography

Beyond code, I run my own **photography business** (events, portraits, automotive, and places) with **40k+ monthly views** and a growing roster of clients.
